        ...
        return (
            <div id="create-post-form-container">
                <div id="create-post-form">
                    ...
                    <div id="create-post-form-body">
                        <form id="form-left-side">
                            ...
                            <div id="select-from-computer">Select from computer</div>
                            <input type="file" accept="image/png, image/jpeg, image/jpg"/>
                        </form>
                        <form id="form-right-side">
                            <div id="form-right-side-header">
                                <img id="form-user-avatar" src={this.props.currentUser.photoUrl}></img>
                                <p>{this.props.currentUser.username}</p>
                            </div>
                            <div>
                                <textarea id="caption-input" type="text" value={this.state.body} placeholder="Write a caption..."></textarea>
                            </div>
                        </form>
                    </div>
                </div>

            ...
            display = 
                <div id="nav-bar">
                    ...
                    <div id="nav-bar-icons">
                        ...
                        <img className="profile-nav-icon nav-bar-icon" onClick={this.showDropdown} src={this.props.currentUser.photoUrl}></img>
                        <div className="profile-nav-icon nav-bar-icon" onClick={this.showDropdown}>

            ...
            display = 
                <div id="nav-bar">
                    ...
                    <div id="nav-bar-icons">
                        ...
                        <img className="profile-nav-icon nav-bar-icon" onClick={this.showDropdown} id={this.state.show ? "profile-nav-icon-active" : ""} src={this.props.currentUser.photoUrl}></img>

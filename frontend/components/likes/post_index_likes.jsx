    ...
    checkLikeStatus() {
        if (this.props.likes.length === 0) {
            ...
            for (let i = 0; i < this.props.likes.length; i++) {
                ...
                if (likeObject.user_id === this.props.currentUser.id) {
                    return likeObject;
                }
            }
        }

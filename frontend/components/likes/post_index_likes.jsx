...
class PostIndexLikes extends React.Component {
    ...
    componentDidMount() {
        ...
        if (like) {
            this.setState({ user_has_like_post: true });
        } else {
            this.setState({ user_has_like_post: false });
        }
    ...
    handleClick() {
        ...
        if (like) {
            this.props.deleteLike(like.id)
                .then(() => this.setState({ user_has_like_post: false }));
        } else {
            let newLike = {
                user_id: this.props.currentUser.id,
            ...
            this.props.createLike(newLike)
                .then(() => this.setState({ user_has_like_post: true }));
        }
    }

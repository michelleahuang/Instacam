    ...
    render() {
        ...
        if (this.props.user.posts.length === 0) {
            ...
            <div id="no-posts-container">
                <div id="no-posts-image-container">
                    <img src="https://img.icons8.com/ios/30/000000/unsplash.png"/>
                </div>
                <p id="no-posts-text">No Posts Yet</p>
            </div>
        } else {
            display = 
            <div id="posts-grid-container">
                {posts.slice(0).reverse().map((post, index) => 
                    <div id="individual-post-item" key={index}>
                        ...
                        <div id="post-photo-overlay" onClick={() => this.props.openModal('show_user_post', post.id)}>
